...
<main class="buy-page">
    <section class="buy-description">
            <div class="box-buy row">
                    ...
                    <div class="col-12 col-sm-6 ">
                            ...
                            <img class="iconos-numeros" src="img/carrito.png" alt="facebook">
              
                              <legend>Comprar Tikets</legend>
              
                              <p>
                                <h6>Name event:<br></br></h6> 
                              ...
                              <p>
                                <p>
                                    <label for="select">Tipo de moneda: <br></br></label>
                                    <select class="Select_select__2fWxq" id="select" name="currency">
                                        <option value="AED">AED - United Arab Emirates Dirham</option>
                                        <option value="AFN">AFN - Afghan Afghani</option>
                                        <option value="ALL">ALL - Albanian Lek</option><option value="AMD">AMD - Armenian Dram</option>
                                        <option value="ANG">ANG - Netherlands Antillean Guilder</option><option value="AOA">AOA - Angolan Kwanza</option>
                                        <option value="ARS">ARS - Argentine Peso</option><option value="AUD">AUD - Australian Dollar</option>
                                        <option value="AWG">AWG - Aruban Florin</option><option value="AZN">AZN - Azerbaijani Manat</option>
